...
func Debugf(template string, args ...interface{}) {
	loadZap()
	_sugaredLogger.Debugw(fmt.Sprintf(template, args...))
}
func Infof(template string, args ...interface{}) {
	loadZap()
	_sugaredLogger.Infow(fmt.Sprintf(template, args...))
}
func Warnf(template string, args ...interface{}) {
	loadZap()
	_sugaredLogger.Warnw(fmt.Sprintf(template, args...))
}
func Errorf(template string, args ...interface{}) {
	loadZap()
	_sugaredLogger.Errorw(fmt.Sprintf(template, args...))
}
func Fatalf(template string, args ...interface{}) {
	loadZap()
	_sugaredLogger.Fatalw(fmt.Sprintf(template, args...))
}
